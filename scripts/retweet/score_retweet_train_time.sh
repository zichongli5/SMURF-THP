...
data=../data/data_retweet/ # datasets directory
batch=16 # batch size
decoder=encode
...
langevin_step=3e-4 # sampling step size; decrease for better sampling, but cost more step
...
var_noise=0.1 # std for noise added # 0.5 for type; 0.05 for time
...
save_name=retweet_${model}_${parametrize}_${decoder}_${add_noise}_${noise_type}_${var_noise}_${normalize} # save model path
...
load_path_name=./checkpoints/retweet/retweet_${model}_${parametrize}_${decoder}_${add_noise}_${noise_type}_${var_noise}_${normalize}.pth
save_result=./results/retweet/retweet_${model}_${parametrize}_${decoder}_${add_noise}_${sampling_method}_${var_noise}_${langevin_step}_samples
